/*
 * Copyright Factory Productions - 10 juin 2004 
 * 
 */
...
/**
 * A fully configurable DOMWriter, derived from the sample DOM writer packaged with Xerces.
 *
 * @author Ludovic Maitre, Factory
...
public class DOMWriter {
	...
	public void setOutput(OutputStream stream, String enc)
	...
	public void write(Node node) {
		...
		switch (type) {
			case Node.DOCUMENT_NODE: {
				...
				if (!fCanonical) {
					if (fXML11) {
						fOut.println("<?xml version=\"1.1\" encoding=\""+encoding+"\"?>");
					}
					else {
						fOut.println("<?xml version=\"1.0\" encoding=\""+encoding+"\"?>");
					}
					fOut.flush();
